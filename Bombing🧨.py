...
# Author: Toxic-Jovan Inc.
# GitHub: https://github.com/Jovanvau
# Version: 4.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Toxic-Jovan  Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/Jovanvau \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Toxic-Jovan               \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
